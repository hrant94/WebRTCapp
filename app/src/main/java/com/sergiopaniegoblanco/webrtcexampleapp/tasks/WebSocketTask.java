...
public class WebSocketTask extends AsyncTask<VideoConferenceActivity, Void, Void> {
    ...
    private static final String TOKEN_URL = "https://d92556d0.ngrok.io/api/tokens";
    private static final String SESSION_URL = "https://d92556d0.ngrok.io/api/sessions";
    ...
    protected Void doInBackground(VideoConferenceActivity... parameters) {
        try {
            String sessionJson = String.format("{\"customSessionId\": \"%s\"}", sessionName);
            ...
            String json = String.format("{\"session\": \"%s\"}", sessionName);
